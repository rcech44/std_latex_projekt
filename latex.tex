...
%\lhead{Sazba technických dokumentů - semestrální projekt}
...
\begin{table}[t] % nebo t, b (muze se i kombinovat jako tb)
    \centering
    
    \begin{tabular}{l r @ {} l r @ {} l r @ {} l r @ {} l r @ {} l} %zarovnani na stred, pohybuju carou (nebo l r...)
    \toprule
...
# or equal to 1, it is not prime
   ...
   print(num,"is not a prime number")
\end{lstlisting}
%\lstinputlisting[language=Python]{SourceCode.py}
